...
import { c as __nuxt_component_0$1, b as useState, _ as _export_sfc, a as useRuntimeConfig } from './server.mjs';
import { defineComponent, computed, ref, mergeProps, unref, withCtx, createTextVNode, toDisplayString, reactive, useSSRContext } from 'vue';
import { ssrRenderAttrs, ssrRenderComponent, ssrRenderAttr, ssrRenderClass, ssrInterpolate, ssrRenderList, ssrRenderStyle, ssrIncludeBooleanAttr } from 'vue/server-renderer';
import { useI18n } from 'vue-i18n';
import { _ as __nuxt_component_0 } from './nuxt-link-BkxPBZ6Z.mjs';
...
const _sfc_main$4 = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    const badges = [
      { text: "Available for work", icon: "\u{1F7E2}", style: "top: 8%; right: -5%" },
      { text: "Based in Indonesia", icon: "\u{1F4CD}", style: "bottom: 25%; left: -8%" },
...
const _imports_0 = "" + buildAssetsURL("logo.BbgdFGzS.jpg");
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props) {
    ...
    function animateSectionContent(index, _prev) {
      var _a;
      const sectionEl = (_a = wrapperRef.value) == null ? void 0 : _a.children[index];
      if (!sectionEl) return;
...
//# sourceMappingURL=index-29FPK8ta.mjs.map
